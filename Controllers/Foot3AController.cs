...
public class Foot3AController : Controller
{
  private readonly ILogger<Foot3AController> _logger;
  private readonly IConfiguration _configuration;
  public Foot3AController(ILogger<Foot3AController> logger, IConfiguration configuration)
  {
    _logger = logger;
