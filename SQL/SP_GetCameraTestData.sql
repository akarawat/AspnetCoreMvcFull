...
-- ============================================================
-- SP_GetCameraTestData
-- Purpose : อ่านข้อมูล Camera Test Data (Focus / Needle X-Y Position)
--           จากตาราง dbo.mig_CameraTestData สำหรับหน้า Dashboard /CameraTestData
--
...
-- ============================================================
CREATE PROCEDURE [dbo].[SP_GetCameraTestData]
...
PRINT 'Stored Procedure [SP_GetCameraTestData] created successfully.';
GO
